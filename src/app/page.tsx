      ...
      <Card className="w-full">
        ...
        <CardContent className="p-4">
          <div className="space-y-2">
            ...
            {/* Baseline Value */}
            <div>
              <h3 className="font-bold mb-2">BASELINE VALUE</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-[auto_2fr_400px_2fr] gap-1 items-center">
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={item.num} className="grid grid-cols-[auto_2fr_400px_2fr] gap-1 items-center">
